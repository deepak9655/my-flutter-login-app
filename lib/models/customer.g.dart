...
const CustomerSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'repairTickets': LinkSchema(
      id: 8618151933068880907,
      name: r'repairTickets',
      target: r'RepairTicket',
      single: false,
      linkName: r'customer',
    )
  },
...
List<IsarLinkBase<dynamic>> _customerGetLinks(Customer object) {
  return [object.repairTickets];
}

void _customerAttach(IsarCollection<dynamic> col, Id id, Customer object) {
  object.id = id;
  object.repairTickets
      .attach(col, col.isar.collection<RepairTicket>(), r'repairTickets', id);
}
...
extension CustomerQueryLinks
    on QueryBuilder<Customer, Customer, QFilterCondition> {
  QueryBuilder<Customer, Customer, QAfterFilterCondition> repairTickets(
      FilterQuery<RepairTicket> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'repairTickets');
    });
  }

  QueryBuilder<Customer, Customer, QAfterFilterCondition>
      repairTicketsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'repairTickets', length, true, length, true);
    });
  }

  QueryBuilder<Customer, Customer, QAfterFilterCondition>
      repairTicketsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'repairTickets', 0, true, 0, true);
    });
  }

  QueryBuilder<Customer, Customer, QAfterFilterCondition>
      repairTicketsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'repairTickets', 0, false, 999999, true);
    });
  }

  QueryBuilder<Customer, Customer, QAfterFilterCondition>
      repairTicketsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'repairTickets', 0, true, length, include);
    });
  }

  QueryBuilder<Customer, Customer, QAfterFilterCondition>
      repairTicketsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'repairTickets', length, include, 999999, true);
    });
  }

  QueryBuilder<Customer, Customer, QAfterFilterCondition>
      repairTicketsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'repairTickets', lower, includeLower, upper, includeUpper);
    });
  }
}
